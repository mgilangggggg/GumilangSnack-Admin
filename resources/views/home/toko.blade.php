...
<head>
    ...
    <title>gumilang snack | toko</title>
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li class="active"><a href="{{ route('toko') }}">Toko</a></li>
                            <li><a href="#">Halaman</a>
                            ...
                            <div class="latest-product__text">
                                ...
                                <div class="latest-product__slider owl-carousel">
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="{{ asset('img/toko/feature-1.jpg') }}" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6>Singkong Original</h6>
                                                <span>30.000</span>
                                            </div>
                                        </a>
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="{{ asset('img/toko/feature-2.jpg') }}" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6>Keciput</h6>
                                                <span>15.000</span>
                                        ...
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="{{ asset('img/toko/feature-3.jpg') }}" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6>Chikbul</h6>
                                                <span>10.000</span>
                                    ...
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="{{ asset('img/toko/feature-4.jpg') }}" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6>Keripik Pisang Manis</h6>
                                                <span>20.000</span>
                                            </div>
                                        </a>
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="{{ asset('img/toko/feature-5.jpg') }}" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6>Pang - Pang</h6>
                                                <span>15.000</span>
                                        ...
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="{{ asset('img/toko/feature-6.jpg') }}" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6>Gemlong Tempe</h6>
                                                <span>15.000</span>
                            ...
                            <div class="product__discount__slider owl-carousel">
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <span>Cemilan</span>
                                            <h5><a href="#">Mie Lidi Asin</a></h5>
                                            <div class="product__item__price">15.000 <span>17.000</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            ...
                                            <div class="product__discount__percent">-1%</div>
                                            <ul class="product__item__pic__hover">
                                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                        ...
                                        <div class="product__discount__item__text">
                                            <span>Keripik</span>
                                            <h5><a href="#">Singkong Balado</a></h5>
                                            <div class="product__item__price">19.000 <span>20.000</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <span>Cemilan</span>
                                            <h5><a href="#">Kopyor</a></h5>
                                            <div class="product__item__price">14.000</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="{{ asset('img/blog/blog-4.jpg') }}">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
